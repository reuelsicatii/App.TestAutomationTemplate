...
Feature: [TAA-248] [Compass]: Local SEO - Local Basic TestSuite v0.1
  ...
  Scenario Outline: LocalSEO_TS02
    ...
    And I populate COM04_CampaignName textfield with <CampaignName>
    And I populate COM04_BrandName textfield with <BrandName>
    And I populate COM04_CampaignURL textfield with <CampaignURL>
    ...
    And I select <product> over COM07_SelectAProduct list
    ...
    Examples: 
      | client                    | category  | product     | productStatus | CampaignName    | BrandName               | CampaignURL                      |
      | lorraine@truelogic.com.ph | Local SEO | Local Basic | Active        | Little Miss BBQ | www.littlemissbbq.com   | https://www.littlemissbbq.com/   |
  ...
  # And I order a product
  # Then Ill see that a product will be successfully assigned to a campaign
  @CPSSMOKETEST @LocalSEO-OrderAProductOnly @LocalSEO_TS02-OrderAProductOnly @TAA-595
  Scenario Outline: LocalSEO_TS02-OrderAProductOnly
    Given Im an Account Manager
    When I navigate to "Login"
    And I populate COM01_Username with "lorraine@truelogic.com.ph"
    And I populate COM01_Password with "123456789"
    ...
    Examples: 
      | client                    | category  | product     | productStatus | CampaignName    | BrandName               | CampaignURL                      |
      | tricia.l@truelogic.com.ph | Local SEO | Local Basic | Active        | Slice Factory   | www.theslicefactory.com | https://www.theslicefactory.com/ |
      | sam@truelogic.com.ph      | Local SEO | Local Basic | Active        | Penumbra        | www.penumbrawinebar.com | https://www.penumbrawinebar.com/ |
      | lorraine@truelogic.com.ph | Local SEO | Local Basic | Active        | Little Miss BBQ | www.littlemissbbq.com   | https://www.littlemissbbq.com/   |
