...
public class AuditWebauditdata extends APIHelper{
	
	
	@When("^I add auditToken to parameter over AuditWebauditdata$")
	public void I_add_auditToken_to_parameter_over_AuditWebauditdata() throws Throwable {
	...
	@Then("^I receive a response with StatusCode ([^\"]*) over AuditWebauditdata$")
	...
	@Then("^I see that response JSON is equal to ([^\"]*) over AuditWebauditdata$")
	...
	@Then("^I see that response JSON matches to ([^\"]*) Schema over AuditWebauditdata$")
	public void I_see_that_response_JSON_matches_to_EXPECTEDJSON_Schema_over_AuditWebauditdata(String arg0) throws IOException {
