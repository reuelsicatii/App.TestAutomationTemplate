...
public class SEO22_SettingsUsers extends WEBHelper {
	...
	public static final WebElement EditIconOfSpecificUser(String email) {
		WebElement editIconOfSpecificUser = driver.findElement(
				By.xpath("(//a[contains(text(),'" + email + "')]/ancestor::tr//a[@title='Edit User'])[1]"));
		return editIconOfSpecificUser;
	}

	public static final WebElement DeleteIconOfSpecificUser(String email) {
		WebElement deleteIconOfSpecificUser = driver.findElement(
				By.xpath("(//a[contains(text(),'" + email + "')]/ancestor::tr//a[@title='Delete User'])[1]"));
	...
	public void i_enter_email_address_textfield_with_existing_email_value(String email)
	...
	public void i_enter_username_textfield_with_existing_user(String username)
			throws Throwable, UnhandledAlertException {
	...
	public void i_click_the_YesDelete_button() throws Throwable, UnhandledAlertException {
		WD.until(ExpectedConditions.elementToBeClickable(Yes_button));
		Assert.assertEquals(true, DeleteUser_header.isDisplayed());
		Yes_button.click();
	...
	public void i_click_the_NoDelete_button() throws Throwable, UnhandledAlertException {
		WD.until(ExpectedConditions.elementToBeClickable(No_button));
		Assert.assertEquals(true, DeleteUser_header.isDisplayed());
		No_button.click();
	...
	public void ill_not_see_the_confirmation_user_successfully_deleted_text() {
		//Nothing to CODE here. No pop-up or confirmation displayed for "No" button
